...
<div>
  ...
  <div class="relative max-w-[290px] min-w-[260px] flex-shrink-0 rounded-md border border-gray-200 bg-white p-2">
    ...
    <div class="space-y-2">
      ...
      <div class="relative">
        ...
        {#if showDropdown && searchResults.length > 0}
          <div class="max-h-80 overflow-y-auto rounded-md border border-gray-200 bg-white shadow-xl" style={dropdownStyle}>
            <div class="divide-y divide-gray-100">
              {#each searchResults as result (result.id)}
                ...
                >
                  <span
                    class={`rounded px-1.5 py-0.5 text-xs font-medium shrink-0
                    ${
                      result.method === 'GET'
                  ...
                  <div class="flex-1 min-w-0">
                    <div class="font-mono text-xs truncate">{result.path}</div>
                    ...
                    {#if result.description}
                      <div class="mt-1 text-[10px] text-gray-400 line-clamp-2">
                        {result.description}
                      </div>
                    {/if}
        ...
        {:else if showDropdown && searchTerm.trim() && !isSearching}
          <div class="rounded-md border border-gray-200 bg-white p-2 shadow-xl" style={dropdownStyle}>
    ...
    <div class="mt-2 text-[10px] text-gray-500">
      Try "create user", "get payment", etc.
    </div>
  </div>
</div>
